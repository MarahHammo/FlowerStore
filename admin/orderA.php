...
<body>
    <nav class="navbar navbar-light bg-light" style="margin-bottom:25px;">
        <div class="container-fluid container">
            <a class="navbar-brand fBold" style="color:#c32f56;font-size:35px;">Orders</span></a>
            <form class="d-flex">
    ...
    <table class="table table-bordered table-striped table-hover table-responsive container">
        <tr class="head">
            ...
            <th class="fBold">Phone Number</th>
            <th class="fBold">Country</th>
            <th class="fBold">City</th>
            <th class="fBold">Address</th>
            <th class="fBold">Card Number</th>
            <th class="fBold">CVC</th>
            <th class="fBold">ZIP</th>
            <th class="fBold">Product NAME</th>
            <th class="fBold">Quantity</th>
            <th class="fBold">#</th>
        </tr>
            ...
            if ($result){
                while ($row = mysqli_fetch_array($result)){?>
                    <tr class="body">
                        ...
                        <td class="del fBold"><a href="orderA.php?delid=<?php echo $row['ID'];?>"><i class="btn btn-light" >Delete</i> </a></td>
