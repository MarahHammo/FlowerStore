...
<body>
    ...
    <main class="flowerSec">
        ...
        <!-- Flower image -->
        <div class="container flowerUser">
            <?php    
                        ...
                        <ul>
                            ...
                            <li>
                                <table style="margin:10px auto;">
                                    <tr>
                                        <td> <h3 class="fRegular price" style="font-size:20px; margin-right:10px; margin-top:7px; color:rgba(165, 82, 119,0.6);">
                                        <?php
                                            echo $row['PRICE'];
                                        ?> $</h3> </td>
                                        ...
                                        <td> <input type="text" class="qty fBold"  value="1" name="qty" style="width:55px; text-align:center;"> </td>
    ...
    <div class="navbarR">
        ...
        <ul class="list1">
            ...
            <li class="fBold border"><a href="plant.php">plant</a></li>
